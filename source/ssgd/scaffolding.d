...
// Default template content constants
...
<body>
  ...
  <footer class="container">
    ...
    pagination = `<nav class="pagination group">
  {{prevLink}}
  {{pageLinks}}
  {{nextLink}}
</nav>`,

    postItem = `<article class="card post-item">
...
string getDefaultTemplate(string templateName)
{
    ...
    {
    case "base.html":
        return DefaultTemplates.base;
    case "index.html":
        return DefaultTemplates.index;
    case "post.html":
        return DefaultTemplates.post;
    case "page.html":
        return DefaultTemplates.page;
    case "pagination.html":
        return DefaultTemplates.pagination;
    case "post_item.html":
        return DefaultTemplates.postItem;
    default:
