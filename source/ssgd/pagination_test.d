...
PresentableContent[] createTestPosts(int count)
{
    PresentableContent[] posts;
    for (int i = 1; i <= count; i++)
    {
        ...
        auto post = new PresentableContent(provider);
        posts ~= post;
    }
    return posts;
}
...
unittest
{
    ...
    auto provider3 = new StringContentProvider(
            "Title: Middle Post\nDate: 2025-01-10\nSlug: middle\n\nMiddle content.",
            "post", "middle");
    auto post3 = new PresentableContent(provider3);
